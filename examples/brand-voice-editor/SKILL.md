...
description: Edits copy to match the included brand voice guide. Use for rewriting short passages in a confident, plain-spoken register without external data or code execution.
---

# What this Skill does
Help rewrite short passages so they conform to the **brand voice** in `references/brand-voice.md`.  
It is **read-only** and **offline**: no network calls, no external tools, no code execution.

## Files
- `references/brand-voice.md` — the sole reference document for tone, vocabulary, and formatting.

## How the agent should use this Skill
1. Read `references/brand-voice.md`.  
